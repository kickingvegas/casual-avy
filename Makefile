...
LISP_DIR=./lisp
MAIN_EL=$(LISP_DIR)/casual-avy.el
VERSION_EL=$(LISP_DIR)/casual-avy-version.el
...
bump-casual:
	...
	sed -i 's/(defconst casual-avy-version "$(VERSION)"/(defconst casual-avy-version "$(VERSION_BUMP)"/' $(VERSION_EL)
